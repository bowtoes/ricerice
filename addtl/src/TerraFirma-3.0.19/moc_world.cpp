...
QT_MOC_LITERAL(1, 6, 6), // "loaded"
QT_MOC_LITERAL(2, 13, 0), // ""
QT_MOC_LITERAL(3, 14, 6), // "status"
QT_MOC_LITERAL(4, 21, 3), // "msg"
QT_MOC_LITERAL(5, 25, 9), // "loadError"
QT_MOC_LITERAL(6, 35, 6) // "reason"

    },
    "World\0loaded\0\0status\0msg\0loadError\0"
    "reason"
};
...
void World::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->loadError((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (World::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&World::loaded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (World::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&World::status)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (World::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&World::loadError)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void World::loadError(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };

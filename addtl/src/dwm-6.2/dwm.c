...
static void chgaps(const Arg *arg);
static void chigaps(const Arg *arg);
static void chogaps(const Arg *arg);
static void chhgaps(const Arg *arg);
static void chvgaps(const Arg *arg);
static void chihgaps(const Arg *arg);
static void chivgaps(const Arg *arg);
static void chohgaps(const Arg *arg);
static void chovgaps(const Arg *arg);
static void tglgaps(const Arg *arg);
static void defgaps(const Arg *arg);
...
drawbar(Monitor *m)
{
    ...
    for (i = 0; i < LENGTH(tags); i++) {
        ...
        if (occ & 1 << i)
            drw_rect(drw, x + boxw, bh - boxw, w - ( 2 * boxw ), boxw - 1,
...
void
defgaps(const Arg *arg)
{
    setgaps(gappoh, gappov, gappih, gappiv);
}

void
chgaps(const Arg *arg)
{
    setgaps(
        selmon->gappoh + arg->i,
        selmon->gappov + arg->i,

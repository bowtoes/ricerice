...
#ifdef FEAT_NORMAL
#define FEAT_VIMINFO
#define VIMINFO_FILE  "$HOME/.config/vim/viminfo"
#define VIMINFO_FILE2 "$HOME/.vim/viminfo"
#define VIMINFO_FILE3 "$HOME/.viminfo"
#endif
 ...
 */
//#define USR_GVIMRC_FILE  "$HOME/.config/vim/gvimrc"
//#define USR_GVIMRC_FILE2 "$HOME/.vim/.gvimrc"
//#define USR_GVIMRC_FILE3 "$HOME/.gvimrc"

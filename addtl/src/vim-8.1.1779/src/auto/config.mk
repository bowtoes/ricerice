...
CC		= gcc
DEFS		= -DHAVE_CONFIG_H
CFLAGS		= -O2 -fno-strength-reduce -Wall -D_REENTRANT -D_REENTRANT -D_REENTRANT  -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=1
CPPFLAGS	= 
srcdir		= .

LDFLAGS		= -L/usr/local/lib -Wl,--as-needed
LIBS		= -lm -ltinfo -lelf -lnsl  -lcanberra  -lacl -lattr -lgpm -ldl
TAGPRG		= ctags
...
COMPILEDBY	= Bow Toes <bow.toes@mailfence.com>
